        ...
        match &expr.inner {
            ...
            ExprInner::Match(scrutinee, arms) => {
                ...
                for arm in arms {
                    ...
                    // Check if this is a catch-all pattern (wildcard `_` or `Rest`).
                    ...
                    // Note: `d1`, `d2`, etc. are NOT catch-all patterns — they are
                    // dummy variable names used in desugared nested matches for
                    // unreachable variant arms. They must be treated as explicit arms.
